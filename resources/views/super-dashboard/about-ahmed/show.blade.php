                    ...
                    <table class="table">
                        ...
                        @foreach($tab->tabSubjects as $i)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('super-dashboard.aboutAhmed.edit', ['id' => $i->id])}}" class="btn btn-primary">
                                ...
                                <span class="switch switch-outline switch-icon switch-success d-flex justify-content-center">
									<label>
                                        ...
                                        data-delete-route="{{route('super-dashboard.aboutAhmed.delete', ['id' => $i->id])}}"
                                               data-restore-route="{{route('super-dashboard.aboutAhmed.restore', ['id' => $i->id])}}"
