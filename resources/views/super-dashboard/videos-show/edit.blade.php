@extends('super-dashboard.index', ['title' => __('keywords.videos.show'). ' | '. __('keywords.edit')])
...
@section('content')
    <div class="card card-custom gutter-b example example-compact">
        ...
        <form action="{{route('super-dashboard.videosShow.update', ['id' => $tabSubject->id])}}" method="post" enctype="multipart/form-data" class="form">
            <div class="card-body">
                @csrf
                ...
                <div class="form-group">
                    ...
                    @enderror
                    <label for="images">{{__('keywords.videos')}}<span class="text-danger">*</span></label>
                    <div>
