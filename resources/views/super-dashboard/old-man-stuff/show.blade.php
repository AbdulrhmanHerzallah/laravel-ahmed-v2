...
@section('content')
    <div class="card card-custom gutter-b">
        <div class="card-header">
            @if(auth()->user()->hasRole(['superAdmin', 'yaseenStuff']) ||  auth()->user()->can('yaseenCreateStuff'))
            <div class="card-title">
                <a href="{{route('super-dashboard.oldManStuff.create')}}" class="btn btn-success mt-ladda-btn ladda-button" data-style="expand-up">
                    ...
                    <table class="table">
                        ...
                        @foreach($tab->tabSubjects as $i)
                            <tr>
                                ...
                                <td>
                                    @if(auth()->user()->hasRole(['superAdmin', 'yaseenStuff']) ||  auth()->user()->can('yaseenDeleteStuff'))
                                    ...
                                    @if(auth()->user()->hasRole(['superAdmin', 'yaseenStuff']) ||  auth()->user()->canany(['yaseenEditStuff', 'yaseenUpdateStuff']))
