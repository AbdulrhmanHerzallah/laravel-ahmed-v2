@extends('super-dashboard.index', ['title' => __('keywords.slider')])
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                <a href="{{route('super-dashboard.slider.create')}}" class="btn btn-success mt-ladda-btn ladda-button" data-style="expand-up">
                    <span class="ladda-label">{{__('keywords.slider.create')}}<i class="fas fa-plus mx-2"></i></span>
                ...
                <div class="example-preview">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th scope="col">{{__('keywords.url')}}</th>
                        ...
                        <tr>
                            <td>
                                <img class="img-fluid img-thumbnail" height="150" width="150" src="{{$slider->image}}" alt="">
                            </td>
                            ...
                            <td>{{$slider->url}}</td>
                            <td>
                                <a href="{{route('super-dashboard.slider.edit', ['id' => $slider->id])}}" class="btn btn-primary">
                                    <i class="far fa-edit"></i>
                                </a>

                                <button data-force-delete="{{route('super-dashboard.slider.forceDelete', ['id' => $slider->id])}}" data-title="{{$slider->title}}" type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete">
                            ...
                            <span class="switch switch-outline switch-icon switch-success d-flex justify-content-center">
									<label>
										<input @if(!$slider->deleted_at) checked @endif
                                        data-delete-route="{{route('super-dashboard.slider.delete', ['id' => $slider->id])}}"
                                        data-restore-route="{{route('super-dashboard.slider.restore', ['id' => $slider->id])}}"
                                        onclick="toggleActiveSlider(event)" type="checkbox"  name="select">
										<span></span>
									</label>
								</span>
                            </td>
