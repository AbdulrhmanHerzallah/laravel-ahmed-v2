@extends('super-dashboard.index', ['title' => __('keywords.images.show')])
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                <a href="{{route('super-dashboard.imagesShow.create')}}" class="btn btn-success mt-ladda-btn ladda-button" data-style="expand-up">
                    ...
                    <table class="table">
                        ...
                        @foreach($tab->tabSubjects as $i)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('super-dashboard.imagesShow.edit', ['id' => $i->id])}}" class="btn btn-primary">
                                        <i class="far fa-edit"></i>
                                    </a>

                                    <button data-force-delete="{{route('super-dashboard.imagesShow.forceDelete', ['id' => $i->id])}}" data-title="{{$i->title}}" type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete">
                            ...
                            <span class="switch switch-outline switch-icon switch-success d-flex justify-content-center">
									<label>
										<input @if(!$i->deleted_at) checked @endif
                                               data-delete-route="{{route('super-dashboard.imagesShow.delete', ['id' => $i->id])}}"
                                               data-restore-route="{{route('super-dashboard.imagesShow.restore', ['id' => $i->id])}}"
