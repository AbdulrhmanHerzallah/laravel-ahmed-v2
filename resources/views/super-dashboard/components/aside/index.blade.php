    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
                ...
                <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                        href="{{route('super-dashboard.oldManImages.show')}}" class="menu-link menu-toggle"><span class="svg-icon menu-icon"><!--begin::Svg Icon | path:/assets/super-dashboard/assets/media/svg/icons/Layout/Layout-4-blocks.svg--><svg
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
...
</svg><!--end::Svg Icon--></span><span class="menu-text">{{__('keywords.old.man.images')}}</span></a></li>

                <li class="menu-section ">
                    <h4 class="menu-text">قسم الجوائز</h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
