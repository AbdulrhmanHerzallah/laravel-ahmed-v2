                        ...
                        @foreach($tab->tabSubjects as $i)
                            ...
                            <span class="switch switch-outline switch-icon switch-success d-flex justify-content-center">
									<label>
                                        ...
                                        data-delete-route="{{route('super-dashboard.oldManImages.delete', ['id' => $i->id])}}"
                                               data-restore-route="{{route('super-dashboard.oldManImages.restore', ['id' => $i->id])}}"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <form action="{{route('super-dashboard.oldManImages.updateViewImage')}}" method="post" enctype="multipart/form-data">
                        @csrf
