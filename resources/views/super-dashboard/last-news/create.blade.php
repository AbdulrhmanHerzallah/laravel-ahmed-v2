@extends('super-dashboard.index', ['title' => __('keywords.last.news'). ' | '. __('keywords.create.new')])
...
@section('content')
    <div class="card card-custom gutter-b example example-compact">
        ...
        <form action="{{route('super-dashboard.lastNews.store')}}" method="post" enctype="multipart/form-data" class="form">
            <div class="card-body">
                @csrf
