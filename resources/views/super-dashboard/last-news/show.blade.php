@extends('super-dashboard.index', ['title' => __('keywords.last.news')])
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                <a href="{{route('super-dashboard.lastNews.create')}}" class="btn btn-success mt-ladda-btn ladda-button" data-style="expand-up">
                    ...
                    <table class="table">
                        ...
                        @foreach($tab->tabSubjects as $i)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('super-dashboard.lastNews.edit', ['id' => $i->id])}}" class="btn btn-primary">
                                        <i class="far fa-edit"></i>
                                    </a>

                                    <button data-force-delete="{{route('super-dashboard.lastNews.forceDelete', ['id' => $i->id])}}" data-title="{{$i->title}}" type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete">
                            ...
                            <span class="switch switch-outline switch-icon switch-success d-flex justify-content-center">
									<label>
                                        ...
                                        data-delete-route="{{route('super-dashboard.lastNews.delete', ['id' => $i->id])}}"
                                               data-restore-route="{{route('super-dashboard.lastNews.restore', ['id' => $i->id])}}"
