@extends('super-dashboard.index', ['title' => __('keywords.last.ads'). ' | '. __('keywords.edit')])
...
@section('content')
    <div class="card card-custom gutter-b example example-compact">
        ...
        <form action="{{route('super-dashboard.lastAds.update', ['id' => $tabSubject->id])}}" method="post" enctype="multipart/form-data" class="form">
            <div class="card-body">
                @csrf
