@extends('super-dashboard.index', ['title' => __('keywords.last.ads')])
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                <a href="{{route('super-dashboard.lastAds.create')}}" class="btn btn-success mt-ladda-btn ladda-button" data-style="expand-up">
                ...
                <div class="example-preview">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th scope="col">{{__('keywords.date')}}</th>
                        ...
                        @foreach($tab->tabSubjects as $i)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('super-dashboard.lastAds.edit', ['id' => $i->id])}}" class="btn btn-primary">
                                        <i class="far fa-edit"></i>
                                    </a>

                                    <button data-force-delete="{{route('super-dashboard.lastAds.forceDelete', ['id' => $i->id])}}" data-title="{{$i->title}}" type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete">
                            ...
                            <span class="switch switch-outline switch-icon switch-success d-flex justify-content-center">
									<label>
                                        ...
                                        data-delete-route="{{route('super-dashboard.lastAds.delete', ['id' => $i->id])}}"
                                               data-restore-route="{{route('super-dashboard.lastAds.restore', ['id' => $i->id])}}"
